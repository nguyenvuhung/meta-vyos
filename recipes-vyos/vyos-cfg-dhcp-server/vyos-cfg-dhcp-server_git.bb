...
HOMEPAGE = "https://github.com/vyos-legacy/vyatta-cfg-dhcp-server"
SECTION = "vyos/dhcp"
...
SRC_URI = "git://github.com/vyos-legacy/vyatta-cfg-dhcp-server.git;branch=current;protocol=https \
	  "
